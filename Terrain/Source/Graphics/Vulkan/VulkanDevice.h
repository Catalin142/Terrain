...
static InstanceProperties getDefaultInstanceProperties()
{
	...
	defaultProps.requestedExtensions	= { VK_KHR_SWAPCHAIN_EXTENSION_NAME, VK_EXT_SHADER_ATOMIC_FLOAT_EXTENSION_NAME, VK_EXT_SHADER_ATOMIC_FLOAT_2_EXTENSION_NAME };
